      ...
      <section>
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          ...
          <SectionHeader
            headerInfo={{
              title: `INTEGRATIONS`,
              subtitle: `Seamless Integration, Unlimited Possibilities.`,
              description: `Easily integrate GiftPool with the tools you already love. Whether you're managing giveaways, crowdfunding campaigns, or donation pools, GiftPool fits right into your workflow with minimal effort.`,
            }}
          />
